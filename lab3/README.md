...
В [`postgres/checks/01_checks.sql`](postgres/checks/01_checks.sql#L50) реализованы следующие аналитические витрины:

| № | Запрос | Строка |
|---|--------|--------|
| 1 | Топ-10 стран по сумме продаж | [L51](postgres/checks/01_checks.sql#L51) |
| 2 | Топ-10 товаров (с категорией и брендом) | [L61](postgres/checks/01_checks.sql#L61) |
| 3 | Продажи по категориям товаров | [L76](postgres/checks/01_checks.sql#L76) |
| 4 | Продажи по брендам | [L88](postgres/checks/01_checks.sql#L88) |
| 5 | Продажи по магазинам (с локацией) | [L100](postgres/checks/01_checks.sql#L100) |
| 6 | Средний чек по странам | [L114](postgres/checks/01_checks.sql#L114) |
| 7 | Продажи по типам питомцев | [L125](postgres/checks/01_checks.sql#L125) |
| 8 | Продажи по породам питомцев | [L136](postgres/checks/01_checks.sql#L136) |
| 9 | Количество продаж по месяцам | [L149](postgres/checks/01_checks.sql#L149) |
| 10 | Самая дорогая продажа | [L159](postgres/checks/01_checks.sql#L159) |
